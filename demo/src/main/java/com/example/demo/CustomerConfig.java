...
public class CustomerConfig {
    ...
    CommandLineRunner intialiseDatabase(){
        ...
        return args -> {
            customerRepo.save(new Customer(1, "divine", false, "debit", "12-34-56", "12345678", "iban", "bic", 50.00d, pastTransactions, c1));
            customerRepo.save(new Customer(2, "Mya", false, "credit", "09-87-65", "09876543", "iban", "bic", 300.00d, pastTransactions, c2));
        };
    }
